...
export type LobbyAction =
  ...
  | { type: "ACCEPT_CHALLENGE"; challengeId: string; matchId: string }
...
export type LobbyEvent =
  ...
  | { type: "CHALLENGE_ACCEPTED"; challengeId: string; matchId: string }
  ...
  | { type: "MATCH_MOVE_REJECTED"; matchId: string; reason: string }
  ...
  | { type: "REMATCH_REJECTED"; matchId: string; reason: string }
